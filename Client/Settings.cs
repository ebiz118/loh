...
namespace Client
{
    class Settings
    {
        ...
        //public static string IPAddress = "86.128.90.177"
        ...
        public static string P_Host = @"http://legendofheroes.net/download/patch/"; 
        ...
        public static string P_BrowserAddress = "http://launcher.legendofheroesnet/";
